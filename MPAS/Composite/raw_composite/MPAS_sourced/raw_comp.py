...
var_list: list[str] = ['theta', 'qv', 'q1', 'rthcuten', 'rthratenlw', 'rthratensw']
...
ax1.set_title(f'Exp: {exp}, Heating: MPAS, Bandpass Filter: No\n\
...
plt.savefig(f'/home/b11209013/2024_Research/MPAS/Composite/raw_composite/Raw_comp_image/MPAS_sourced/{exp}_raw_comp.png', dpi=300)
# %%
