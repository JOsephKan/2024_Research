...
tot_tot: np.ndarray = data['pc1']['tot'] + data['pc2']['tot']
...
Lower: Column-integrated Temperature (k), LW (royalblue), SW (sienna), CU (forestgreen)',
fontsize=10, loc='left')
plt.savefig(f'/home/b11209013/2024_Research/MPAS/Composite/LRF_sourced/heating_image/CNTL_tot_heating.png', dpi=300)
