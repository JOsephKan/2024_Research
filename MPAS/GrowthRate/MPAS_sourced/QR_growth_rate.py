...
qr: dict[str, np.ndarray] = {
    'pc1': chunking['pc1']['lw']+chunking['pc1']['sw'],
    'pc2': chunking['pc2']['lw']+chunking['pc2']['sw'],
}

## 1. Compute Growth Rate
sigma: dict[str, dict[str, np.ndarray]] = {
    'pc1': Growth_Rate(qr['pc1'], chunking['pc1']['t']),
    'pc2': Growth_Rate(qr['pc2'], chunking['pc2']['t']),
}

## 2. Compute Phase
phase: dict[str, dict[str, np.ndarray]] = {
    'pc1': Phase(chunking['pc1']['t'], qr['pc1']),
    'pc2': Phase(chunking['pc2']['t'], qr['pc2']),
}

## 3. Compute Coherence Square
coh2: dict[str, dict[str, np.ndarray]] = {
    'pc1': Coherence(qr['pc1'], chunking['pc1']['t']),
    'pc2': Coherence(qr['pc2'], chunking['pc2']['t']),
}
...
plt.savefig(f'/home/b11209013/2024_Research/MPAS/GrowthRate/image/{exp}_QR_PC1.png', dpi=300)
plt.show()
...
plt.savefig(f'/home/b11209013/2024_Research/MPAS/GrowthRate/image/{exp}_QR_PC2.png', dpi=300)
# %%
