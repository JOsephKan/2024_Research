...
sigma: dict[str, dict[str, np.ndarray]] = {
    'pc1': Growth_Rate(chunking['pc1']['lw'], chunking['pc1']['t']),
    'pc2': Growth_Rate(chunking['pc2']['lw'], chunking['pc2']['t']),
}

## 2. Compute Phase
phase: dict[str, dict[str, np.ndarray]] = {
    'pc1': Phase(chunking['pc1']['t'], chunking['pc1']['lw']),
    'pc2': Phase(chunking['pc2']['t'], chunking['pc2']['lw']),
}

## 3. Compute Coherence Square
coh2: dict[str, dict[str, np.ndarray]] = {
    'pc1': Coherence(chunking['pc1']['lw'], chunking['pc1']['t']),
    'pc2': Coherence(chunking['pc2']['lw'], chunking['pc2']['t']),
}
...
plt.savefig(f'/home/b11209013/2024_Research/MPAS/GrowthRate/image/LW/{exp}_PC1.png', dpi=300)
plt.show()
...
plt.savefig(f'/home/b11209013/2024_Research/MPAS/GrowthRate/image/LW/{exp}_PC2.png', dpi=300)
# %%
