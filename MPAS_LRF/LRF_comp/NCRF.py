...
# load data
def load_data(var):
    with nc.Dataset(f"/work/b11209013/MPAS/tropic_data/NCRF/{var}.nc", "r", mmap=True) as f:
...
# ============ #
# load data
path = "/work/b11209013/MPAS/tropic_data/NCRF/"
...
with open("/work/b11209013/MPAS/LRF/NCRF.pkl", "wb") as f:
    pkl.dump(lrf, f)
