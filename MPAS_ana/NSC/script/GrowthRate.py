...
def main():
    ...
    tname = "/work/b11209013/MPAS/NSC/merged_data/tropic_data/t/tPC.nc"
    ...
    q1name = "/work/b11209013/MPAS/NSC/merged_data/tropic_data/Q1/Q1PC.nc"
    ...
    plt.suptitle("EAPE Growth Rate (NSC)")

    fig.colorbar(cf, ax=ax, orientation="horizontal", aspect=30, shrink=0.35, label=r"$\sigma$ [1/day]")
    plt.savefig("/home/b11209013/2024_Research/MPAS_ana/NSC/image/GrowthRate.png", dpi=500)
    plt.show()
    ...
    plt.savefig("/home/b11209013/2024_Research/MPAS_ana/NSC/image/GrowthRate_EOF2.png", dpi=500)
    plt.show()
